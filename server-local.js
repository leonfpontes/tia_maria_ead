...
const apiHandlers = {
  ...
  'PATCH /api/admin/senhas/[id]': require('./api/admin/senhas/[id].js'),
  'GET /api/admin/mediuns': require('./api/admin/mediuns/index.js'),
  'POST /api/admin/mediuns': require('./api/admin/mediuns/index.js'),
